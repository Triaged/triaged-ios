...
- (id)initInScrollView:(UIScrollView *)scrollView activityIndicatorView:(UIView *)activity
{
    ...
    if (self)
	{
        ...
        _activityIndicator.center = CGPointMake(floor(self.frame.size.width / 2), floor(self.frame.size.height));
...
- (void)beginRefreshing
{
    if (!self.refreshing)
	{
        ...
        [self.scrollView setContentInset:UIEdgeInsetsMake(self.originalContentInset.top, self.originalContentInset.left, self.originalContentInset.bottom, self.originalContentInset.right)];
        self.ignoreInset = NO;
...
//				);
                ...
                self.activityIndicator.center = CGPointMake(
                                                            floor(self.frame.size.width / 2),
                                                            MIN(offset + self.frame.size.height + floor(kOpenedViewHeight),
                                                                self.frame.size.height - kOpenedViewHeight));
