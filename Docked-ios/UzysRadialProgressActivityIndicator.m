...
- (void)setProgress:(double)progress
{
    ...
    if (progress >= 0 && progress <=1.0) {
        ...
        animationImage.fromValue = [NSNumber numberWithFloat:DEGREES_TO_RADIANS(270-270*prevProgress)];
        animationImage.toValue = [NSNumber numberWithFloat:DEGREES_TO_RADIANS(270-270*progress)];
        animationImage.duration = 0.25;
